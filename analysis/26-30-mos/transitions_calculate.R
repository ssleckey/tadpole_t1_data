...
read_in <- '~/Desktop/tadpole_t1_data/analysis/26-28-mo/transitions/'
readout <- '~/Desktop/tadpole_t1_data/analysis/26-28-mo/transitions_processed/'
setwd("~/Desktop/tadpole_t1_data/analysis/26-28-mo/")
